...
import dev.purppecat.purps_mcu_reborn.client.renderer.CpuIThreeRenderer;
...
public class CpuIThreeItem extends Item implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public CpuIThreeItem(Properties properties) {
        super(properties);
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private CpuIThreeRenderer renderer;

            @Override
            public BlockEntityWithoutLevelRenderer getGeoItemRenderer() {
                if (this.renderer == null)
                    this.renderer = new CpuIThreeRenderer();
